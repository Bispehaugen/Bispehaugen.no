<?php 
	...
	//TODO bredde p√• tabellen, bare hente opp de 10 siste og ha en knapp med 'vis alle' som printer smtlige innlegg
	...
	//Henter ut siste uleste innlegg i trÂd
    ...
    #Det som printes pÂ sida
    
    //Her legges det inn en oversikt over alle forumene
    list_forum();
	//skriver ut temaet for denne tr√•den
    echo "<table class='forum'><tr><th colspan = '3'>".$tema['tittel']."</th></tr>";

   	//skriver ut alle innleggene valgte forum og tema i forumet sortet p√• sist oppdaterte med siste innlegg og av hvem
   	foreach($foruminnlegg as $forum_innlegg){
      	...
      	//if for Â sjekke om det er foruminnlegg
